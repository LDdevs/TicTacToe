...
public class tictac extends JPanel implements ActionListener {
	...
	public void drawUI(Graphics page) {
        ...
        page.setColor(red);
		page.fillOval(43 + 190 + offset, 45, 30, 30);
		page.setColor(darkgray);
		page.fillOval(49 + 190 + offset, 50, 19, 19);
		...
		if (gameDone) {
			if (winner == 1) { // x
				page.drawString("Game Over", 310, 150);
		...
		// DRAW LOGO
		Image logo = Toolkit.getDefaultToolkit().getImage("Images/apples.png");
		page.drawImage(logo, 345, 235, 30, 30, this);
		...
		for (int i = 0; i < 3; i++) {
			for (int j = 0; j < 3; j++) {
				if (board[i][j] == 0) {
                    ...
                    // ImageIcon xIcon = new ImageIcon("Images/apples.png");
					// // ImageIcon xIcon = new ImageIcon("C:\\Users\\lisad\\OneDrive\\Desktop\\stuff\\My Projects\\Java\\TicTacToe\\Images\\greenapple.png");
